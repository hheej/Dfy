...
class HiRiseBot(BaseBot):
    ...
    def __init__(self):
        ...
        # ── پیام‌های قابل تنظیم ──
        self.welcome_text = "🎉  {user} <#ffffff> درود دوست عزیز به لابی ایران خوش اومدی🤍 برای دنس زدن کد دنس مورد نظر خودتونو بزنید یا از 1 تا  213 رو تایپ کنید🌹 به یاد صادق عزیز🖤 " 
        self.goodbye_text  = "👋 {user} <#ffffff> درود دوست عزیز به لابی ایران خوش اومدی🤍 برای دنس زدن کد دنس مورد نظر خودتونو بزنید یا از 1 تا  213 رو تایپ کنید🌹 به یاد صادق عزیز🖤 "
